...
import com.gptbot.gptbot.data.db.DiagnosticRunEntity
import com.gptbot.gptbot.data.db.FlowchartDao
import com.gptbot.gptbot.data.db.FlowchartEntity
import com.gptbot.gptbot.data.model.DiagnosticSession
import com.gptbot.gptbot.data.model.FlowNode
import com.gptbot.gptbot.data.model.FlowchartData
import com.gptbot.gptbot.data.templates.DefaultFlowcharts
        ...
        return dao.getAllDiagnosticRunsFlow().map { list ->
            list.map { entity ->
                DiagnosticSession(
                    ...
                    steps = runCatching { json.decodeFromString<List<com.gptbot.gptbot.data.model.DiagnosticStep>>(entity.stepsJson) }.getOrDefault(emptyList()),
