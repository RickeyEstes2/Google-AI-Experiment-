package com.example.solveflow.engine.log

import com.example.solveflow.data.model.LogEntry

object LogSearchEngine {

    val sampleAndroidLogcat = """
2026-09-09 14:22:01.102 14201 14201 INFO AndroidRuntime: Calling main entry com.example.solveflow.MainActivity
...
2026-09-09 14:22:04.112 14201 14266 ERROR AndroidRuntime: Process: com.example.solveflow, PID: 14201
2026-09-09 14:22:04.112 14201 14266 ERROR AndroidRuntime: java.lang.NullPointerException: Parameter specified as non-null is null: method com.example.solveflow.engine.latex.LatexRenderer.format, parameter rawLatex
2026-09-09 14:22:04.112 14201 14266 ERROR AndroidRuntime: 	at com.example.solveflow.engine.latex.LatexRenderer.format(LatexRenderer.kt:42)
2026-09-09 14:22:04.112 14201 14266 ERROR AndroidRuntime: 	at com.example.solveflow.ui.viewmodel.ChatViewModel${'$'}solveMath${'$'}1.invokeSuspend(ChatViewModel.kt:188)
...
2026-09-09 14:22:05.002 14201 14201 INFO ActivityManager: Process com.example.solveflow (pid 14201) has died
    """.trimIndent()
        ...
        return buildString {
            ...
            when {
                lower.contains("nullpointerexception") -> {
                    ...
                    appendLine("- **Fault Location**: `com.example.solveflow.engine.latex.LatexRenderer.format(LatexRenderer.kt:42)`.")
