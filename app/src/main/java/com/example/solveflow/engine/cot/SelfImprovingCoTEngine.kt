package com.example.solveflow.engine.cot

import com.example.solveflow.data.model.*
import com.example.solveflow.engine.contradiction.ContradictionDetectorEngine
import com.example.solveflow.engine.log.LogSearchEngine
import com.example.solveflow.engine.math.MathSolverEngine
        ...
        return when (mode) {
            ...
            ChatMode.CODE_GEN -> {
                buildString {
                    ...
                    appendLine()
                    appendLine("```kotlin")
                    appendLine("package com.example.solveflow.domain")
                    appendLine()
                    appendLine("/**")
